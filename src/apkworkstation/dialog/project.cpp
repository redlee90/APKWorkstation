    ...
    QDialog(parent)
{
    ...
    this->_ok = new QPushButton(tr("Ok"), this->_buttons);
    // Layout
    ...
    this->connect(this->_ok, SIGNAL(clicked()), SLOT(accept()));
    /*
     * @Inflate
     */
    // Button
    this->_buttons->addButton(this->_cancel, QDialogButtonBox::RejectRole);
    this->_buttons->addButton(this->_ok, QDialogButtonBox::AcceptRole);
    // Layout
